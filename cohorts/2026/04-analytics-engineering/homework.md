...
```
East Harlem North/470139.45
```
```
SELECT pickup_zone, revenue_monthly_total_amount 
FROM `symmetric-ion-480511-d2.dbt_demo.fct_monthly_zone_revenue` 
...
```sql
SELECT count(*) FROM `symmetric-ion-480511-d2.dbt_demo.stg_fhv_tripdata` 
```
